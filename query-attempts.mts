...
async function main() {
  ...
  try {
    ...
    const studentId = "sample-academy-student-student";
    ...
    console.log(
      `Found ${attempts.length} attempts for quiz ${quizId} and student ${studentId}\n`,
    );
    ...
    if (attempts.length >= 2) {
      ...
      console.log(`\n--- Duplicate Check ---`);
      console.log(
        `Time between most recent and second most recent attempt: ${timeDiffSeconds} seconds`,
      );
      ...
      if (timeDiffSeconds < 5) {
        ...
        console.log(
          `This suggests a browser reload+submit sequence created MULTIPLE attempts (duplicate creation).`,
        );
      } else {
        console.log(
