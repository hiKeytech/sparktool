...
export const CertificateTemplate = ({
  certificate,
  institutionName = "SparkTool",
  instructorName = "Training Coordinator",
  logoUrl,
  ref,
    ...
    >
      ...
      <Group justify="space-around" mb={40}>
        <Stack align="center" gap="xs">
          <Text style={{ color: "#359a61", fontSize: "16px", fontWeight: 600 }}>
            COMPLETION DATE
          </Text>
          <Text style={{ color: "#1f2937", fontSize: "18px", fontWeight: 500 }}>
      ...
      >
        ...
        >
          This certificate is issued electronically by {institutionName}.
          <br />
          Use the learning portal to verify certificate ID:{" "}
