...
export function CreateUser({ tenant }: TenantPageProps) {
  ...
  const handleSubmit = async (values: CreateUserFormData) => {
    ...
    if (tenant?.id) {
      navigate({ params: { tenant: tenant.id }, to: "/$tenant/admin/users" });
    }
  };
    ...
    <Container size="sm" py="xl">
      <Stack gap="xl">
        <div>
          ...
          <Text c="dimmed">
            Create a password-based account for a student or administrator
          </Text>
        </div>
          ...
          <form onSubmit={form.onSubmit(handleSubmit)}>
            <Stack gap="md">
              ...
              <Group justify="flex-end" mt="md">
                ...
                <Button loading={createUser.isPending} type="submit">
                  Create Account
                </Button>
              </Group>
            </Stack>
