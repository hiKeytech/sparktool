...
export function StudentLayout() {
  ...
  const navigationItems: {
    ...
    },
    {
      ...
      routeId: "/student/live-sessions",
    },
    {
      icon: IconProgress,
      label: "My Progress",
      path: "/student/progress",
      routeId: "/student/progress",
    },
    {
      icon: IconUserCircle,
      label: "Profile",
  ...
  return (
    ...
    >
        ...
        <Container h="100%" size="xl">
          <Group h="100%" justify="space-between" px="md">
            ...
            <Group>
              ...
              <Group gap="sm">
                <NCSLogo size={44} />
                <Text className="hidden text-white sm:block" fw={700} size="xl">
      ...
      {/* Main Content */}
      <AppShell.Main>
        <div className="min-h-full" data-aos="fade-up" data-aos-duration="500">
          <Outlet />
        </div>
      </AppShell.Main>
    </AppShell>
